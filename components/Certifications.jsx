...
const certs = [
  {
    ...
    url: "https://www.freecodecamp.org/certification/keshavk/responsive-web-design",
  },
  {
...
const Certifications = () => {
  return (
    <section id="certifications" className="p-section">
      <Header title="Certifications" />
      <div className="mt-2 flex flex-col gap-3">
        {certs.map(({ title, url }) => (
          <Link className="inline hover:text-teal-400" key={url} href={url}>
            <LinkSvg />
            {title}
          </Link>
        ))}
