...
const Arrow = () => (
  <svg
    ...
    className="mb-1 ml-1 inline-block h-5 transition-transform duration-300 group-hover/arrow:-rotate-45 group-hover/arrow:text-teal-400"
    stroke="currentColor"
    fill="none"
    strokeLinecap="round"
...
const NavLink = ({ href, children, underline = false }) => {
  return (
    <Link
      className="group/arrow font-medium text-slate-200 focus-visible:text-teal-400 hover:text-teal-400"
      target="_blank"
      href={href}
    >
      <span
