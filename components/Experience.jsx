          ...
          <div className="mt-4 border-t border-slate-700/50 pt-3">
            ...
            <div className="mt-2 flex flex-col gap-1.5">
              <div className="flex items-center gap-1.5 text-[11px] text-slate-300">
                <svg className="h-3 w-3 flex-shrink-0 text-slate-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="flex items-center gap-1.5 text-[11px] text-slate-400 transition-colors hover:text-teal-400 w-fit"
              >
              ...
              >
                ...
                <span>eko.agustavia@kcic.co.id</span>
              </a>
            </div>
          </div>
        </div>
